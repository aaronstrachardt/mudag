...
def get_file_from_commit(repo_path: str, commit_hash: str, file_path: str) -> Optional[str]:
    """
...
def get_files_at_commit(repo_path: str, commit_hash: str, workflow_only: bool = True) -> List[str]:
    """
