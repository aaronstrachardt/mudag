...
def main():
    ...
    if os.path.exists("examples/workflow.cwl"):
        ...
        print(f"File: examples/workflow.cwl")
...
""")
        ...
        try:
            ...
            if "__metadata__" in results and "workflow_languages" in results["__metadata__"]:
                ...
                for lang, stats in lang_stats.items():
                    if stats["files"] > 0:
                        print(f"{lang}: {stats['files']} files, {stats['total']} total lines")
        finally:
